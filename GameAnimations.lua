...
-- Walk animation id: 6405419618
-- Run animation id: 6361709833
local animTable = {}
local animNames = { 
	idle = 	{	
	...
	walk = 	{ 	
		{ id = "http://www.roblox.com/asset/?id=6405419618", weight = 10 } 
	}, 
	run = 	{
		{ id = "http://www.roblox.com/asset/?id=6361709833", weight = 10 } 	-- Is actually the walking animation
	}, 
	swim = 	{
...
function onRunning(speed)
	...
	-- Modified
	print(speed)
	if speed >= 0.01 and speed <= 8 then
		pose = "Walking"
		playAnimation("walk", 0.2, Humanoid)
	elseif speed > 8 then
		pose = "Running"
